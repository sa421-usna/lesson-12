...
- [MiKTeX](https://miktex.org) is a distribution of [LaTeX](https://www.latex-project.org) for Windows.
...
- Note the extra `\ ` at the end of the line. This prevents a caption from appearing.
...
- There are many things you can do to make your R Markdown documents look nice and professional. Google is your friend, but be aware that sometimes the top results don't give the best or easiest way to accomplish something. 
